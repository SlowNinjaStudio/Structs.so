...
export class DroidUIStructureCondensedDrainListener extends DroidUIListenerInterface{
  ...
  init() {
    document.getElementById('structure_list_drain_' + this.component.structure.getId()).addEventListener('click', async function() {
      // Hide the selector
