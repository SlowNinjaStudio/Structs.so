...
export function schematic_FeatureFromJSON(object: any): Schematic_Feature {
  switch (object) {
    case 0:
    case "PAPER_WEIGHT":
...
export function schematic_FeatureToJSON(object: Schematic_Feature): string {
  switch (object) {
...
export function schematic_AmbitFromJSON(object: any): Schematic_Ambit {
  switch (object) {
    case 0:
    case "VOID":
...
export function schematic_AmbitToJSON(object: Schematic_Ambit): string {
  switch (object) {
...
export const Schematic = {
  encode(message: Schematic, writer: Writer = Writer.create()): Writer {
    if (message.creator !== "") {
  ...
  decode(input: Reader | Uint8Array, length?: number): Schematic {
    ...
    const message = { ...baseSchematic } as Schematic;
    message.features = [];
    message.ambits = [];
