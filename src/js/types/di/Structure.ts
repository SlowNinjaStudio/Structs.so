...
export function structure_FeatureFromJSON(object: any): Structure_Feature {
  switch (object) {
    case 0:
    case "PAPER_WEIGHT":
...
export function structure_FeatureToJSON(object: Structure_Feature): string {
  switch (object) {
...
export function structure_AmbitFromJSON(object: any): Structure_Ambit {
  switch (object) {
    case 0:
    case "VOID":
...
export function structure_AmbitToJSON(object: Structure_Ambit): string {
  switch (object) {
...
export const Structure = {
  encode(message: Structure, writer: Writer = Writer.create()): Writer {
    if (message.creator !== "") {
  ...
  decode(input: Reader | Uint8Array, length?: number): Structure {
    ...
    const message = { ...baseStructure } as Structure;
    message.features = [];
    message.ambits = [];
      ...
      switch (tag >>> 3) {
        ...
        case 10:
          if ((tag & 7) === 2) {
            const end2 = reader.uint32() + reader.pos;
            while (reader.pos < end2) {
              message.ambits.push(reader.int32() as any);
            }
          } else {
            message.ambits.push(reader.int32() as any);
          }
        ...
        case 12:
          ...
          break;
        case 13:
          message.accuracy = longToNumber(reader.uint64() as Long);
          break;
        case 14:
          message.energyEfficiency = longToNumber(reader.uint64() as Long);
          break;
        case 15:
          message.mass = longToNumber(reader.uint64() as Long);
          break;
        case 16:
          message.strength = longToNumber(reader.uint64() as Long);
          break;
        case 17:
          message.meleeAttack = longToNumber(reader.uint64() as Long);
          break;
        case 18:
          message.rangeAttack = longToNumber(reader.uint64() as Long);
          break;
        case 19:
          message.meleeDefense = longToNumber(reader.uint64() as Long);
          break;
        case 20:
          message.rangeDefense = longToNumber(reader.uint64() as Long);
          break;
        case 21:
          message.generateRate = longToNumber(reader.uint64() as Long);
          break;
        case 22:
          message.chargeRate = longToNumber(reader.uint64() as Long);
          break;
        case 23:
          message.drainRate = longToNumber(reader.uint64() as Long);
          break;
        case 35:
          message.chargingSlotCount = longToNumber(reader.uint64() as Long);
          break;
        case 36:
          message.chargingSlot.push(reader.string());
          break;
        case 24:
          message.buildRate = longToNumber(reader.uint64() as Long);
          break;
        case 25:
          message.restorationRate = longToNumber(reader.uint64() as Long);
          break;
        case 26:
          message.capacityMax = longToNumber(reader.uint64() as Long);
          break;
        case 27:
          message.healthCurrent = longToNumber(reader.uint64() as Long);
          break;
        case 28:
          message.healthMax = longToNumber(reader.uint64() as Long);
          break;
        case 29:
        ...
        case 32:
          if ((tag & 7) === 2) {
            const end2 = reader.uint32() + reader.pos;
            while (reader.pos < end2) {
              message.storage.push(longToNumber(reader.uint64() as Long));
            }
          } else {
            message.storage.push(longToNumber(reader.uint64() as Long));
          }
          break;
        case 33:
          message.capacityCurrent = longToNumber(reader.uint64() as Long);
          break;
        case 34:
  ...
  fromJSON(object: any): Structure {
    ...
    if (
      object.energyEfficiency !== undefined &&
    ...
    if (
      object.chargingSlotCount !== undefined &&
    ...
    if (
      object.restorationRate !== undefined &&
    ...
    if (
      object.capacityCurrent !== undefined &&
