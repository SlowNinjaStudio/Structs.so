...
export class MechShootingAnimation {
  cannonFireScript() {
    return function() {
  ...
  make() {
    const mechConfiguration = [
      '/img/structures/mobile/mech/mobile-mech-body.png',
      '/img/structures/mobile/mech/mobile-mech-power.png',
      '/img/structures/mobile/mech/mobile-mech-sky.png',
      //'/img/structures/mobile/mech/mobile-mech-defense.png',
    ];
