  ...
  explosionScript() {
    return function() {
      ...
      if (this.frameCount < 4) {
        ...
        this.context.ellipse(this.x, this.y, 14, 6, Math.PI, 0, 2 * Math.PI);
        this.context.stroke();

        this.context.beginPath();
        this.context.ellipse(this.x, this.y, 14, 14, Math.PI, 0, Math.PI);
        this.context.stroke();
        ...
        this.context.beginPath();
        this.context.ellipse(this.x, this.y, 6, 2, Math.PI, 0, 2 * Math.PI);
        this.context.stroke();

        this.context.fillStyle = '#ffffcc';
        this.context.beginPath();
        this.context.ellipse(this.x, this.y, 6, 6, Math.PI, 0, Math.PI);
        this.context.stroke();
      } else if (this.frameCount < 8) {
        this.context.fillStyle = '#ffff99';
        this.context.beginPath();
        this.context.ellipse(this.x, this.y, 7, 3, Math.PI, 0, 2 * Math.PI);
        this.context.stroke();
        this.context.fill();

        this.context.fillStyle = '#ffffcc';
        this.context.beginPath();
        this.context.ellipse(this.x, this.y, 7, 7, Math.PI, 0, Math.PI);
        this.context.stroke();
        this.context.fill();
        ...
        this.context.fillStyle = '#ffff99';
        this.context.beginPath();
        this.context.ellipse(this.x, this.y, 21, 9, Math.PI, 0, 2 * Math.PI);
        this.context.stroke();
        this.context.fill();

        this.context.fillStyle = '#ffffcc';
        this.context.beginPath();
        this.context.ellipse(this.x, this.y, 21, 21, Math.PI, 0, Math.PI);
        this.context.stroke();
        this.context.fill();
      } else if (this.frameCount < 14) {
        this.context.beginPath();
        this.context.ellipse(this.x, this.y, 28, 12, Math.PI, 0, 2 * Math.PI);
        this.context.stroke();

        this.context.beginPath();
        this.context.ellipse(this.x, this.y, 28, 28, Math.PI, 0, Math.PI);
        this.context.stroke();
